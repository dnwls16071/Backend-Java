...
public class TestZone {
	public static void main(String[] args) {
		...
		ZonedDateTime londonTime = ZonedDateTime.of(LocalDate.of(2024, 1, 1),
				LocalTime.of(9, 0), ZoneId.of("Europe/London"));
		ZonedDateTime newYorkTime = ZonedDateTime.of(LocalDate.of(2024, 1, 1),
				LocalTime.of(9, 0), ZoneId.of("America/New_York"));
